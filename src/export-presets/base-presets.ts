 ...
 * @param version Version string (e.g., "4.3.2", "3.5.1")
 * @returns Major version number (3 or 4)
 */
export function getMajorVersion(version: string): GodotMajorVersion {
  ...
  return major as GodotMajorVersion;
}

/**
 * Check if a base preset exists for the given platform and version
 */
export function hasBasePreset(
  platform: Platform,
  version: GodotMajorVersion
): boolean {
  return (
    (platform === "Android" && (version === 3 || version === 4)) ||
    (platform === "iOS" && (version === 3 || version === 4))
  );
}

/**
 * Get base preset for platform and version
 */
...
/**
 * Base preset for Android (Godot 3.x)
 */
export function getBasePreset_Android_v3(): ExportPreset {
  return {
    name: "Android",
    platform: "Android",
    runnable: true,
...
/**
 * Base preset for Android (Godot 4.x)
 */
export function getBasePreset_Android_v4(): ExportPreset {
  return {
    name: "Android",
    platform: "Android",
    runnable: true,
...
/**
 * Base preset for iOS (Godot 3.x)
 */
export function getBasePreset_iOS_v3(): ExportPreset {
  return {
    name: "iOS",
    platform: "iOS",
    runnable: true,
...
/**
 * Base preset for iOS (Godot 4.x)
 */
export function getBasePreset_iOS_v4(): ExportPreset {
  return {
    name: "iOS",
    platform: "iOS",
    runnable: true,
